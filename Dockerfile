...
ENV MONGO_ENTERPRISE_MANAGER_BUILD		4.0.2.50187.20180905T1454Z-1
ENV MONGO_ENTERPRISE_MANAGER_USER			mongoopsmanager
# #
...
RUN 				cd /tmp \
							&& curl -OL https://downloads.mongodb.com/on-prem-mms/deb/mongodb-mms-$MONGO_ENTERPRISE_MANAGER_BUILD.x86_64.deb \
